...
docker-machine ssh dev "docker run -dt -p 9000:9000 -p 9001:9001 -p 10022:22 --name=php-xdebug --volumes-from websites --link mongo --link mysql --link memcache --add-host deakerss.int:192.168.99.100 ikovalyov/php-xdebug"
